...
function QuizListContent() {
  ...
  }, [isLoaded, user, shouldRefresh, isMounted, pathname, router]) // Added isMounted to dependencies
...
// Create the main component which wraps the content in a Suspense boundary
